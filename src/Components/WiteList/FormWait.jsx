  ...
  return (
    <div style={{ display: "flex", backgroundColor: "#f5f5f5", }}>
      <div style={{ width: "100%", padding: "10px", marginLeft: "50px", marginTop: "50px" }}>
        <Typography variant="h5" gutterBottom style={{ color: "gray", fontWeight: "bold", marginTop: "20px" ,maxHeight:"100%",width:"100%"}}>
          To enter Configuration Screen, please enter the details
        </Typography>
        <Button variant="outlined" color="primary" onClick={handleOpenDialog} style={{ margin: "10px" ,marginLeft:"500px"}}>
